...
public class Player : MonoBehaviour {
	...
	public void setCurrentCheckpoint(GameObject newCurrent) {
		if(CurrentCheckpoint != null) {
			Checkpoint deact = (Checkpoint) CurrentCheckpoint.GetComponent(typeof(Checkpoint));
			deact.deactivate();
		}
		...
		Checkpoint act=(Checkpoint) CurrentCheckpoint.GetComponent(typeof(Checkpoint));
		act.activate();
	}
}